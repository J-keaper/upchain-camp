...
contract Score {
    ...
    // 老师可以查询所有学生的分数
    function queryScore(address student) public view  onlyTeacher returns(uint) {
    ...
    function setTeacher(address _teacher) public onlyOwner {
        require(Address.isContract(_teacher), "Teacher should is contract address");
        teacher = _teacher;
    }
...
contract Teacher{
    ...
    function queryScore(address class, address student) public view returns(uint) {
